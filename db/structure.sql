...
ALTER TABLE ONLY public.cor1440_gen_actorsocial_efecto
    ADD CONSTRAINT fk_rails_12f7139ec8 FOREIGN KEY (actorsocial_id) REFERENCES public.sip_orgsocial(id);
...
ALTER TABLE ONLY public.cor1440_gen_actividad_actorsocial
    ADD CONSTRAINT fk_rails_8ba599a224 FOREIGN KEY (actorsocial_id) REFERENCES public.sip_orgsocial(id);
